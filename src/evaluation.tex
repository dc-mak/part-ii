...
\gpink{pink}, \gyellow{yellow}, \gpurple{purple} and \gdgreen{dark-green}, and
...
Figure~\ref{fig:oot:module}. The seven \gpink{pink} circles near the center
are BG sections 1-6 and appendices A and B. As the first sections, they lay the
groud-work for the rest of the theory; % -- backed up by sugiyama flipped

% Right pink group Puig? and appendices
% Left pink prime_length? and 1-6
% Scattered are..?
...
% Sugiyama: linearity/multiplicity of tracks/thoughts
% Grid allows us to estimate proportion of each group
