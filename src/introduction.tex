...
\prechapter{%
  ...
  formalise mathematical theories into machine-check proofs. Coq libraries,
  which encode mathematical theories, are difficult to understand. In this
  dissertation, I will describe a new tool I implemented for Coq users which
  applies network-analysis techniques (usually associated with social-networks)
  to generate new data and uncover new insights about Coq libraries.
}
...
help with the challenge of gaining a high-level understanding of a large Coq
library.
...
medium-sized Coq library (Combinators for Algebraic Structures).
