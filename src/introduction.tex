...
\prechapter{%
  ...
  creates a graph database from compiled Coq proof-scripts and applies
  network-analysis techniques (usually associated with social-networks) to
  generate new data and uncover new insights about Coq libraries.
}
